...
def generate_page(from_path, template_path, dest_path, basepath):
    ...
    template_lines = template_lines.replace('href="/', f"href=\"{basepath}")
    template_lines = template_lines.replace('src="/', f"src=\"{basepath}")
    ...
    for item in cur_dir:
        ...
        if os.path.isfile(new_source):
            if new_source.endswith(".md"):
                ...
                generate_page(new_source, template_path, new_dest, basepath)
        else:
